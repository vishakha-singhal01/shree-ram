const Gallery = ()=>(
    <>
    <section>
        <h1 className="font-bold  text-5xl m-2 p-2 text-orange-500 text-center">Photo Gallery</h1>
    <div className="flex flex-wrap justify-around mb-3">
        <img className="w-72 h-56 p-3 m-3 shadow-md bg-white  hover:scale-110 transition duration-500 cursor-pointer" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0CKd-i5KW-Okgu0Pr5D0poy5QW8SQAwBDN6FTmh4n4hngpL94LRnmWMvvltcUo1QWjUg&usqp=CAU"/>
        <img className="w-72 h-56 p-3 m-3 shadow-md bg-white  hover:scale-110 transition duration-500 cursor-pointer" src="https://images.livemint.com/img/2020/08/05/1600x900/PTI05-08-2020_000070B_1596616220560_1596616237975.jpg"/>
