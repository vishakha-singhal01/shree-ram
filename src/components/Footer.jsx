...
<footer className="bg-yellow-300 mt-8">
  <div className="mx-auto max-w-screen-xl px-1 pb-2 pt-8 sm:px-6 lg:px-8">
    ...
    <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
      <div className="mx-auto max-w-sm lg:max-w-none">
        <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
          This web app is created for the information purpose and to create community of all Ram Bhakt.
        </p>
      ...
      <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
        <div>
          ...
          <ul className="mt-6 space-y-1">
            <li>
              <Link className="text-gray-700 transition hover:text-gray-700/75" to="/about"> About Darshan </Link>
            </li>

            <li>
              <Link className="text-gray-700 transition hover:text-gray-700/75" to="/darshan">
                Darshan Info
              </Link>
            </li>
        ...
        <div>
          ...
          <ul className="mt-6 space-y-1">
            ...
            <li>
              <Link className="text-gray-700 transition hover:text-gray-700/75" to="/"> Our Team </Link>
            </li>
          </ul>
        </div>
    ...
    <div className="mt-16 border-t border-gray-100 pt-8">
      <p className="text-center text-xs/relaxed text-gray-500">
        ...
        Created with
        <Link to="" className="text-gray-700 underline transition hover:text-gray-700/75">React JS</Link>    
      </p>
    </div>
  </div>
</footer>
